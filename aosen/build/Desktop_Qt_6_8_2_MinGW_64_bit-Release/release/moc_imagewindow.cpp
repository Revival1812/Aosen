...
namespace {
struct qt_meta_tag_ZN11ImageWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11ImageWindowE = QtMocHelpers::stringData(
    "ImageWindow",
    "showSpotDetail",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ImageWindowE[] = {
...
Q_CONSTINIT const QMetaObject ImageWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ImageWindowE.offsetsAndSizes,
    qt_meta_data_ZN11ImageWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ImageWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ImageWindow, std::true_type>,
        // method 'showSpotDetail'
...
void ImageWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->showSpotDetail(); break;
        default: ;
        }
    }
    (void)_a;
...
void *ImageWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ImageWindowE.stringdata0))
