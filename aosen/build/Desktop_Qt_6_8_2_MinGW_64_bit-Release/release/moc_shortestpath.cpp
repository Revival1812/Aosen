...
static constexpr auto qt_meta_stringdata_ZN12ShortestPathE = QtMocHelpers::stringData(
    "ShortestPath",
    "initSignalSlots",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ShortestPathE[] = {
...
Q_CONSTINIT const QMetaObject ShortestPath::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ShortestPathE.offsetsAndSizes,
    qt_meta_data_ZN12ShortestPathE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ShortestPathE_t,
        // Q_OBJECT / Q_GADGET
...
void *ShortestPath::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ShortestPathE.stringdata0))
